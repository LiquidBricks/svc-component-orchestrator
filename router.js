...
export const routes = [
  ...
  [component.evt.compute_function_failed.data.path, component.evt.compute_function_failed.data.spec],
  [component.evt.compute_function_failed.gate.path, component.evt.compute_function_failed.gate.spec],
  [component.evt.compute_function_failed.task.path, component.evt.compute_function_failed.task.spec],
  ...
  [domain.edge.injects_into.injected.path, domain.edge.injects_into.injected.spec],
  [domain.snapshot.data.result.path, domain.snapshot.data.result.spec],
  [domain.snapshot.gate.result.path, domain.snapshot.gate.result.spec],
  [domain.snapshot.task.result.path, domain.snapshot.task.result.spec],
  [domain.snapshot.data.computation_failed.path, domain.snapshot.data.computation_failed.spec],
  [domain.snapshot.gate.computation_failed.path, domain.snapshot.gate.computation_failed.spec],
  [domain.snapshot.task.computation_failed.path, domain.snapshot.task.computation_failed.spec],
