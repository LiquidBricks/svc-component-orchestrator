...
async function completeInstanceChain({ g, dataMapper, emits, natsContext, instanceVertexId, stateMachineId, instanceId, visited, finishedCache, stateStatusOverrides }) {
  ...
  for (const parent of parents) {
    await completeInstanceChain({ g, dataMapper, emits, natsContext, ...parent, visited, finishedCache, stateStatusOverrides })
  }
}
