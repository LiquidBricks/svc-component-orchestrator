...
export function createConsumerConfig() {
  return {
    ...
    filter_subjects: [
      ...
      createBasicSubject(natsEvents['*'].component_service['*'].function_result.evt.component.compute_function_failed.v1.data).forSubscribe().build(),
      createBasicSubject(natsEvents['*'].component_service['*'].function_result.evt.component.compute_function_failed.v1.gate).forSubscribe().build(),
      createBasicSubject(natsEvents['*'].component_service['*'].function_result.evt.component.compute_function_failed.v1.task).forSubscribe().build(),
      ...
      createBasicSubject(natsEvents['*'].domain['*']['*'].snapshot.data.computation_failed.v1['*']).forSubscribe().context('delta').build(),
      createBasicSubject(natsEvents['*'].domain['*']['*'].snapshot.gate.computation_failed.v1['*']).forSubscribe().context('delta').build(),
      createBasicSubject(natsEvents['*'].domain['*']['*'].snapshot.task.computation_failed.v1['*']).forSubscribe().context('delta').build(),
